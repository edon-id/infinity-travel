...
const CroatiaApartments: NextPage<Props> = ({ arrangements }) => {
  const filterByCountryAndProperty = arrangements.filter(
    (arr) =>
      arr.propertyType?.includes("Apartment") &&
      arr.location.country?.includes("Croatia")
  );
...
export default CroatiaApartments;
